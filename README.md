...
[![](https://godoc.org/github.com/misu99/go-rabbitmq?status.svg)](https://godoc.org/github.com/misu99/go-rabbitmq)![Deploy](https://github.com/misu99/go-rabbitmq/workflows/Tests/badge.svg)
...
```bash
go get github.com/misu99/go-rabbitmq
```
